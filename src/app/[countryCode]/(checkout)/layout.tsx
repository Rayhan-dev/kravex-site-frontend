...
export default function CheckoutLayout({
  ...
  return (
    <>
      ...
      <div className="w-full bg-[#dfd9c2] lg:hidden">
        <Layout>
          <LayoutColumn>
      ...
      <Layout>
        <LayoutColumn className="flex max-lg:flex-col-reverse lg:justify-between relative">
          ...
          <div className="absolute right-0 top-0 lg:max-w-[calc((50vw-50%)+448px)] xl:max-w-[calc((50vw-50%)+540px)] -mr-[calc(50vw-50%)] bg-[#dfd9c2] h-full w-full max-lg:hidden" />
        </LayoutColumn>
      </Layout>
    </>
  )
