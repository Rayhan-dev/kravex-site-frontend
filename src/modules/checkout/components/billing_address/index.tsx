...
const BillingAddress = ({
  ...
  return (
    <>
      ...
      !isBillingAddressEmpty(formData) ? (
        <div className="w-full border border-black/10 rounded-xs p-4 flex flex-wrap gap-8 max-lg:flex-col mt-8">
          <div className="flex flex-1 gap-8">
            <Icon name="user" className="w-6 h-6 mt-2.5" />
            <div className="flex flex-col gap-8 flex-1">
              <div className="flex flex-wrap justify-between gap-6">
                <div className="grow basis-0">
                  <p className="text-xs text-black/50 mb-1.5">Country</p>
                  <p>
                ...
                <div className="grow basis-0">
                  <p className="text-xs text-black/50 mb-1.5">Address</p>
              ...
              <div className="flex flex-wrap justify-between gap-6">
                ...
                <div className="grow basis-0">
                  <p className="text-xs text-black/50 mb-1.5">City</p>
                  ...
                  >
                    {addressesInRegion?.map((address) => (
                      ...
                      >
                        ...
                        <UiRadioLabel className="ml-auto text-black/50 group-data-[selected=true]:font-normal">
                          {[
                            address.address_1,
                            address.address_2,
