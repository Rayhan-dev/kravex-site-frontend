...
export const UiCheckboxBox: React.FC<React.ComponentPropsWithoutRef<"div">> = ({
  ...
  <div
    {...props}
    className={twMerge(
      "border border-black/25 w-4 h-4 flex items-center group-hover:border-black/60 justify-center group-data-[selected=true]:bg-black group-data-[selected=true]:border-black group-hover:group-data-[selected=true]:border-black group-hover:group-data-[selected=true]:bg-black/80 transition-colors",
      className
    )}
  />
)
